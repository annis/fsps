PROGRAM SIMHA
  ...
  do i=1,6
     if (i == 1 ) pset%zmet = 10  ! Z = 0.0020  ! log Z = -0.98
     if (i == 2 ) pset%zmet = 14  ! Z = 0.0049  ! log Z = -0.59
     if (i == 3 ) pset%zmet = 17  ! Z = 0.0096
     if (i == 4 ) pset%zmet = 20  ! solar metalicity, Z  = 0.0190
     if (i == 5 ) pset%zmet = 22  ! Z = 0.030
     if (i == 6 ) pset%zmet = 4  ! Z = 0.0005  low metallicty pop
     do j=1,4
     	if (j == 1 ) pset%sf_start = 0.7
     	if (j == 2 ) pset%sf_start = 1.0
     	if (j == 3 ) pset%sf_start = 1.5
     	if (j == 4 ) pset%sf_start = 2.0
     	do k=1,4
     	   ...
     	   do l=1,7
     	      ...
     	      do m=1,5
     	         if (m == 1 ) pset%sf_theta = -0.175  ! 10 degrees
     	         if (m == 2 ) pset%sf_theta = -0.524  ! 30 degrees
     	         if (m == 3 ) pset%sf_theta = -0.785  ! 45 degrees
     	         if (m == 4 ) pset%sf_theta = -1.047  ! 60 degrees
